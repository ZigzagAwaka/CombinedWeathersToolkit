...
namespace CombinedWeathersToolkit
{
    class Config
    {
        ...
        public Config(ConfigFile cfg)
        {
            ...
            UniqueWeatherAlgorithm = cfg.Bind("Misc", "Unique weather Algorithm", "", "When filled by a valid weather name, this config will override WeatherTweaks weather Algorithm to force spawn the selected weather every day on every moons.");
